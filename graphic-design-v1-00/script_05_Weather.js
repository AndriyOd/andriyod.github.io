...
function SetInitialCity() {
    let citiesArr = document.querySelectorAll('#wcities-grid-container > div');
...
document.querySelector('#wX').addEventListener('click',()=>{
    document.querySelector('#wpopup-background').style.display="none";
    document.querySelector('#wpopup-window').classList.remove('active');
...
document.querySelector('#wpopup-cancel').addEventListener('click',()=>{
    document.querySelector('#wpopup-background').style.display="none";
    document.querySelector('#wpopup-window').classList.remove('active');
// Reset selected city to the chosen city (previous selection) 
    document.querySelector('#wcities-grid-container > div.selected').classList.remove('selected');
...
document.querySelector('#wpopup-ok').addEventListener('click',()=>{
    document.querySelector('#wpopup-background').style.display="none";
    document.querySelector('#wpopup-window').classList.remove('active');
// Set chosen city equal to the selected city (new selection) 
    gChosenCity = document.querySelector('#wcities-grid-container > div.selected');
